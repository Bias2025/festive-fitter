...
const H = {
  ...
  'silver-statement-jacket': { bg: '#2A2A2E', garment: '#B8BCC2', accent: '#C1272D', pattern: 'stripe', legwear: '#C1272D' },
  // Christmas · sweaters
  sweater:              { bg: '#5A1E1E', garment: '#E8DFC8', accent: '#C9BFA6', pattern: 'cable' },
  ...
  'burgundy-velvet-gown':    { bg: '#2E0F16', garment: '#5A1622', accent: '#7A2436', pattern: 'plain', long: true },
  'lace-snowflake-catsuit':  { bg: '#1A1A1A', garment: '#141414', accent: '#C9A227', pattern: 'fairisle', legwear: '#141414' },
  'green-sequin-skirt-set':  { bg: '#12261C', garment: '#141414', accent: '#137A4E', pattern: 'plain', legwear: '#137A4E' },
  'silver-cutout-midi':      { bg: '#2A2A2E', garment: '#C3C6CC', accent: '#9AA0A8', pattern: 'waffle', long: true },
  'gold-fringe-jumpsuit':    { bg: '#241E12', garment: '#141414', accent: '#C9A227', pattern: 'stripe', legwear: '#141414' },
  'green-velvet-halter-gown':{ bg: '#0F2E22', garment: '#0E4B34', accent: '#C9A227', pattern: 'plain', long: true },
  ...
  'pj-fairisle':          { bg: '#2F4B3F', garment: '#E8DFC8', accent: '#B0403A', pattern: 'fairisle', legwear: '#E8DFC8' },
  'pj-green-satin':        { bg: '#123C29', garment: '#0F5136', accent: '#C9A227', pattern: 'buttons', legwear: '#0F5136' },
  ...
  // Christmas · suiting & outerwear
  'green-velvet-tuxedo':     { bg: '#12261C', garment: '#123C29', accent: '#0C0C0C', pattern: 'lapel', legwear: '#141414' },
  'burgundy-snowflake-coat': { bg: '#2E0F1C', garment: '#6E2439', accent: '#C9A227', pattern: 'fairisle', long: true, legwear: '#141414' },
  'tartan-wool-coat':        { bg: '#2E1A22', garment: '#6E2A38', accent: '#1B4332', pattern: 'plaid', long: true, hat: 'beanie', legwear: '#3A2A2A' },
  'black-wool-overcoat':     { bg: '#1C1C1E', garment: '#161616', accent: '#3A3A3A', pattern: 'buttons', long: true, legwear: '#141414' },
  'puffer-jacket':           { bg: '#2A2622', garment: '#1A1A1A', accent: '#BB8B5C', pattern: 'stripe', legwear: '#161616' },
  // Christmas · loungewear
  'plaid-flannel-shirt':     { bg: '#3A2A1E', garment: '#6E4A2E', accent: '#1A1A1A', pattern: 'plaid', legwear: '#2A3550' },
  'velvet-robe':             { bg: '#2E0F1C', garment: '#6E2439', accent: '#4A1526', pattern: 'plain', long: true },
...
const LABELS = {
  ...
  'mrs-claus': 'Mrs. Claus Dress', 'silver-statement-jacket': 'Silver Statement Jacket',
  sweater: 'Cream Turtleneck Knit', 'cream-sweater-dress': 'Cream Sweater Dress',
  ...
  'green-velvet-blazer': 'Green Velvet Dinner Jacket', 'green-velvet-tuxedo': 'Green Velvet Tuxedo',
  'burgundy-snowflake-coat': 'Snowflake Overcoat', 'tartan-wool-coat': 'Tartan Wool Coat',
  'black-wool-overcoat': 'Black Wool Overcoat', 'puffer-jacket': 'Colourblock Puffer',
  'plaid-flannel-shirt': 'Plaid Flannel Shirt', 'velvet-robe': 'Velvet Robe',
  'burgundy-velvet-gown': 'Burgundy Velvet Gown', 'lace-snowflake-catsuit': 'Lace Snowflake Catsuit',
  'green-sequin-skirt-set': 'Sequin Skirt Set', 'silver-cutout-midi': 'Silver Cutout Midi',
  'gold-fringe-jumpsuit': 'Gold Fringe Jumpsuit', 'green-velvet-halter-gown': 'Green Velvet Halter Gown',
  'pj-red-plaid': 'Red Check Flannel Set', 'pj-green-satin': 'Green Satin Pyjamas',
  'pj-fairisle': 'Fair Isle Knit Set', 'pj-reindeer-onesie': 'Reindeer Onesie',
